...
//numeros entre -128 y 127 Control de versiones def
  float gen1[10]= {124, 120, 115, 120, 116, 120, 127, 120, 98, 93};//valores genes para motor izq
  float gen2[10] = {98, 114, 97, 124, 95, 104, 97, 80, 76, 121};//valores genes para motor der
